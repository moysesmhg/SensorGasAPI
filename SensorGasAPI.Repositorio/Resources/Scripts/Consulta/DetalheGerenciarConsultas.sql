     SELECT (Pessoa.PrimeiroNomePessoa || ' ' || Pessoa.SobreNomePessoa) NomeSolicitante
           ...
           , '(' || CAST(DadosAdicionais.DDDTelefoneDadosAdicionais AS VARCHAR) || ') ' || CAST(DadosAdicionais.NumeroTelefoneDadosAdicionais AS VARCHAR) TelefoneSolicitante
           , Consulta.SituacaoConsulta SituacaoConsulta
           , DadosAdicionais.EmailDadosAdicionais EMailSolicitante
        FROM Consulta
